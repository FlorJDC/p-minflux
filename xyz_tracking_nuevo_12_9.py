...
class Backend(QtCore.QObject):
    ...
    def update_graph_data(self): #Incorporo cambios con vistas a añadir data actualizada de z
        ...
        if self.ptr < self.npoints:
            ...
            self.zData[self.ptr] = self.z #Aparentemente es self.focusSignal
            ...
            self.zData[-1] = self.z # Es self.focusSignal
...
##            print(datetime.now(), '[xy_tracking] else')
    ...
    def correct(self, mode='continous'): #No me puedo guiar del correct de xyz_tracking de rastmin porque la correción es distinta
