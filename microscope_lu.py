...
class Frontend(QtGui.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        ## xy tracking dock
        self.xyzWidget = xyz_tracking.Frontend()
        
        xyzDock = QDockWidget('xyz drift control', self)
        xyzDock.setWidget(self.xyzWidget)
        xyzDock.setFeatures(QDockWidget.DockWidgetVerticalTitleBar | 
                                 QDockWidget.DockWidgetFloatable |
                                 QDockWidget.DockWidgetClosable)
        xyzDock.setAllowedAreas(Qt.RightDockWidgetArea)
        
        self.addDockWidget(Qt.RightDockWidgetArea, xyzDock)
...
#        self.addDockWidget(Qt.BottomDockWidgetArea, focusDock)
        ...
        self.xyzWidget.setMinimumSize(800, 598)
...
class Backend(QtCore.QObject):
    ...
    xyzMoveAndLockSignal = pyqtSignal(np.ndarray)
    ...
    def __init__(self, adw, ph, ccd, scmos, diodelaser, *args, **kwargs):
        ...
        self.xyzWorker = xyz_tracking.Backend(ccd, adw)
