...
def start_acquisition():
    try:
        ...
        m_dataStream.StartAcquisition(peak.AcquisitionStartMode_Default, peak.DataStream.INFINITE_NUMBER) #aqui está el error
...
def main():
    ...
    if not prepare_acquisition():
        # error
        sys.exit(-2)
    if not set_roi(16, 16, 256, 256): #Antes en lugar 256 estaba 128
        # error
        sys.exit(-3)
