...
class LaserWidget(QtGui.QFrame):
    ...
    def getIntensities(self):
        ...
        print('INTENSITY THREAD STARTED')
    ...
    **Signals:**
    ...
    def __init__(self, main, scansPerS, port, calPath, *args, **kwargs):
        ...
        try:
            ...
            self.calibration['laser'] = [405, 532, 642]
    ...
    def start(self):
        ...
        for control in enabledControls:
            ...
            print('LASER IS {}'.format(laser))
            print('CALIBRATION IS {}'.format(self.calibration))
