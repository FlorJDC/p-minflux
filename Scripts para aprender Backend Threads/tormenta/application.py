...
def main():
    ...
    with instruments.Camera('andor.ccd.CCD') as andor, \
            instruments.Laser('mpb.vfl.VFL', 'COM9') as redlaser, \
            instruments.Laser('rgblasersystems.minilasevo.MiniLasEvo', 'COM7') as bluelaser, \
            instruments.Laser('laserquantum.ventus.Ventus', 'COM12') as greenlaser, \
            instruments.Laser('laserquantum.gem.Gem', 'COM13') as cyanlaser, \
            instruments.DAQ() as daq, instruments.ScanZ(3) as scanZ:      # (3) means COM3
