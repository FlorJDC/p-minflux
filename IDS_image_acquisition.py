# -*- coding: utf-8 -*-
"""
Created on Tue Oct 10 15:49:32 2023
...
def open_camera():
    ...
    try:
        ...
        # open the first openable device in the device manager's device listdevice_count = device_manager.Devices().size()
        for i in range(device_count):
            print("error dentro del codigo)")
        ...
        str_error = str(e)
        print("There was an error: ", str_error)
...
def prepare_acquisition():
    ...
    try:
        ...
        str_error = str(e)
        print("There was an error in prepare acquisition: ", str_error)
...
def set_roi(x, y, width, height):
    try:
        ...
        str_error = str(e)
        print("There was an error setting roi. Error: ", str_error)
...
def alloc_and_announce_buffers():
    try:
        ...
        str_error = str(e)
        print("There was an error with buffers. Error: ", str_error)
    return False
...
def start_acquisition():
    try:
        ...
        str_error = str(e)
        print("There was an error starting_acquisition. Error: ", str_error)
    return False
